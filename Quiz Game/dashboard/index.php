                ...
                <div class="a col-9 bg-primary-subtle ">
                    <section class="a">
                        <div class="col-md-3 pt-2 mx-auto shadow-sm  mb-5  rounded">
                            ...
                            $a++;
                            ?>
                            <h1 class="text-primary kotta-one-regular text-center ">Question 1</h1>
                        </div>
                        <div>
                            <h1 class="hanuman-regular">
                                ...
                                $sql = "SELECT question FROM questions WHERE questions_id=1";
                    ...
                    <section class="b">
                        <form action="../dashboard/score/index_check_answer.php" method="post" id="genderForm">
                            <?php
                            $servername = "localhost";
                            $username = "root";
                            $password = "";
                            ...
                            $i = 1;
                            // SQL query to retrieve data
                            $sql = "SELECT a,b,c,d FROM lists WHERE lists_id=1";
                            $result = $conn->query($sql);
                            ...
                            <?php 
                                    ...
                                    ?>
                                    <input type="hidden" name="row_id" value="<?php echo $a; ?>">
                        </form>
                        <script>
                    ...
                    <section class="c">
                        <div class="container">
                            ...
                            <div class=" p-4 d-flex flex-row-reverse">
                                ...
                                <form action="../dashboard/next_question.php" method="post">
                                    ...
                                    <input type="hidden" name="current_question_id" value="<?php echo htmlspecialchars($row['questions_id']); ?>">
